...
class LoginRegistration extends Component {
    ...
    checkRedirections = () => {
        ...
        if (urlParams != "" && queryString.includes("email_verification_code")) {
            this.setState({
                screenLoading: true
            })
            CommonPost("api/v1/account/email-verify", null, { Code: queryString.replace("?email_verification_code=", "") })
                .then(res => {
                    if (res.isSuccess) {
                    ...
                    openNotification(NotificationStatusTypes.Error, '', "Email verification error occurred!");
                    this.setState({
                        screenLoading: false
                    })
                })
    ...
    onChangeEmail = (e) => {
        ...
        this.setState({
            ...
            if (value === "") {
                $("#login-email-err").text("Require email address");
            } else {
    ...
    onPasswordChange = (e) => {
        ...
        this.setState({
            ...
            if (value === "") {
                $("#login-password-err").text("Require password");
            } else {
    ...
    onConfirmPasswordChange = (e) => {
        ...
        this.setState({
            ...
            if (value === "") {
                $("#login-confirmPassword-err").text("Require confirm password");
            } else {
    ...
    onFirstNameChange = (e) => {
        ...
        this.setState({
            ...
            if (value === "") {
                $("#login-firstName-err").text("Require first name");
            } else {
    ...
    onLastNameChange = (e) => {
        ...
        this.setState({
            ...
            if (value === "") {
                $("#login-lastName-err").text("Require last name");
            } else {
    ...
    validateEmail = (value, errorId, displayFieldName) => {
        if (value === "") {
            $("#" + errorId).text("Require " + displayFieldName + " address");
            return false;
        }
    ...
    validatePassword = (value, errorId, displayFieldName) => {
        if (value === "") {
            $("#" + errorId).text("Require " + displayFieldName);
            return false;
        }
        var isValid = value !== "";
        if (!isValid)
    ...
    onLoginClick = () => {
        ...
        CommonPost("api/v1/account/login", null, data)
            .then(res => {
                if (res.isSuccess) {
                    if (res.data != null) {
    ...
    onRegisterClick = () => {
        ...
        CommonPost("api/v1/account", null, data)
            .then(res => {
                if (res.isSuccess) {
                    openNotification(NotificationStatusTypes.Success, "", res.message);
                    this.setState({
