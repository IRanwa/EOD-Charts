...
namespace IRanwa.EOD.Chart.Data.Migrations
{
    ...
    [Migration("20230403143136_2023-04-03-v1")]
    partial class _20230403v1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IRanwa.EOD.Chart.Data.AspNetEmailVerifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AspNetEmailVerifications");
                });

            modelBuilder.Entity("IRanwa.EOD.Chart.Data.AspNetForgetPassword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AspNetForgetPassword");
                });

            modelBuilder.Entity("IRanwa.EOD.Chart.Data.AspNetUsersHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IRanwa.EOD.Chart.Data.ExchangeSymbol", b =>
                {
                    ...
                    b.HasIndex("AnnualSyncCompleted");

                    b.HasIndex("Code");

                    b.HasIndex("DataSyncCompleted");

                    b.HasIndex("ExchangeCodeId");

                    b.HasIndex("QuarterlySyncCompleted");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "1",
                            ConcurrencyStamp = "bd997a79-3b44-4b49-b7f7-c166fcceea5f",
                            Name = "SuperAdmin",
                        ...
                        {
                            Id = "2",
                            ConcurrencyStamp = "1a8a1e5b-b3da-488e-99d6-0a3be180755a",
                            Name = "Admin",
                        ...
                        {
                            Id = "3",
                            ConcurrencyStamp = "ef9a8e8b-378c-4878-a3db-19511aafce1e",
                            Name = "Guest",
            ...
            modelBuilder.Entity("IRanwa.EOD.Chart.Data.AspNetEmailVerifications", b =>
                {
                    b.HasOne("IRanwa.EOD.Chart.Data.ApplicationUser", "User")
                        .WithMany()
